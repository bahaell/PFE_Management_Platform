...
export default function EditRoomPage() {
  ...
  if (!room) {
    return (
      <div className="space-y-6 p-4 sm:p-6">
        <PageHeader title="Room Not Found" description="The requested room does not exist" />
        <Card className="p-8 sm:p-12 text-center">
          <p className="text-muted-foreground mb-4">Room ID {roomId} not found</p>
          <Button onClick={() => router.push('/coordinator/rooms')}>
            Back to Rooms
          </Button>
        </Card>
      </div>
      ...
      <form onSubmit={handleSubmit}>
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
          ...
          <div className="lg:col-span-2 space-y-4 sm:space-y-6">
            ...
            <RoomAvailabilitySection roomId={String(roomId)} />
          </div>
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <Card className="p-4 sm:p-6 bg-amber-50 dark:bg-amber-950/20 border-amber-200 dark:border-amber-900">
              ...
              <p className="text-xs text-muted-foreground">
                Changes will take effect immediately. Make sure to verify equipment status before saving.
              </p>
            </Card>
          </div>
        </div>

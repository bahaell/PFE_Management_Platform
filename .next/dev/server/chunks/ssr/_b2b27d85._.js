...
"[project]/app/teacher/availability/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function TeacherAvailabilityPage() {
    ...
    const { data: slots = [], isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            'teacher-availability'
        ],
        queryFn: ()=>__TURBOPACK__imported__module__$5b$project$5d2f$services$2f$service_teacherAvailability$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TeacherAvailabilityService"].getAvailableSlots()
    });
    const handleAddSlot = async (slotData)=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$service_teacherAvailability$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TeacherAvailabilityService"].addSlot(slotData);
    ...
    const handleUpdateSlot = async (slotData)=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$service_teacherAvailability$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TeacherAvailabilityService"].updateSlot(editingSlot.id, slotData);
            queryClient.invalidateQueries({
                queryKey: [
                    'teacher-availability'
                ]
    ...
    const handleDeleteSlot = async (id)=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$service_teacherAvailability$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TeacherAvailabilityService"].deleteSlot(id);
            queryClient.invalidateQueries({
                queryKey: [
                    'teacher-availability'
                ]
...
//# sourceMappingURL=_b2b27d85._.js.map